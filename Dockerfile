...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2020/01/13 16:00:45 by cmeunier          #+#    #+#              #
#    Updated: 2020/01/20 14:46:39 by cmeunier         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
RUN service mysql start																								&& \
	...
	mysql -u root -e "GRANT ALL ON *.* TO 'celestin'@'localhost' IDENTIFIED BY 'qwerty'"							&& \
